...
public enum TransactionType {
     ...
     * View bills.
     */
    BILLS_VIEW ( 2100, "Office visit bills viewed", true ),

    /**
     * Create bills.
     */
    BILLS_CREATE ( 2101, "Office visit billing created", true ),

    /**
     * Edit bills.
     */
    BILLS_EDIT ( 2102, "Office visit billing updated", true ),

    /**
     * Fulfill a single bill payment.
     */
    BILL_FULLPAYMENT_SINGLE ( 2200, "Bill fully paid with single payment", true ),

    /**
     * Fulfill a partial bill payment.
     */
    BILL_PARTPAYMENT_SINGLE ( 2201, "Bill partially paid with single payment", true ),

    /**
     * Fulfill a full bill payment.
     */
    BILL_FULLPAYMENT_MULTIPLE ( 2202, "Bill fully paid with multiple payments", true ),

    /**
     * Fulfill a full bill payment.
     */
    BILL_PARTPAYMENT_MULTIPLE ( 2203, "Bill partially paid with multiple payments", true ),

    /**
     * CPTCode created.
     */
    CPTCODE_CREATE ( 2300, "BSM Created new CPT Code", false ),

    /**
     * CPTCode modified.
     */
    CPTCODE_EDIT ( 2301, "BSM edited CPT Code", false ),

    /**
     * CPTCode removed from database.
     */
    CPTCODE_DELETE ( 2302, "BSM deleted CPT code", false );
