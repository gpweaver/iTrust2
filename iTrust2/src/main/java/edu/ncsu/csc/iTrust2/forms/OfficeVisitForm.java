...
public class OfficeVisitForm implements Serializable {
    ...
    /**
     * Sets the list of CPT codes for this office visit.
     *
     * @param cptCodes
     *            the list of CPT codes for this office visit
     */
    ...
    /**
     * Returns the list of CPT codes for this office visit.
     *
     * @return the list of CPT codes for this office visit
     */
