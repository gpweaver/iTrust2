...
public class APISatisfactionSurveyTest {
    ...
    public void setup () {
        ...
        code.setDescription( "<Duration>" );
        code.setCost( 10.05f );
        cptCodeService.save( code );
    }
    ...
    private void buildOfficeVisit () throws Exception {
        ...
        final List<CPTCodeForm> forms = new ArrayList<>();
        forms.add( new CPTCodeForm( cptCodeService.findByCode( "00000" ) ) );
        visit.setCptCodes( forms );
